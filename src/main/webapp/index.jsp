                                    ...
                                    <div id="hometab" class="home-tab container">
                                        ...
                                        <section class="ttfeatured-products clearfix">
                                            ...
                                            <div class="ttfeatured-content products">
                                                <% ResultSet rsFeatured = pDAO.getFeaturedProducts();
                                                                    ...
                                                                    <div class="ttproducthover">
                                                                        ...
                                                                        <div class="tt-button-container">
                                                                            <div class="product-add-to-cart">
                                                                                <form method="post" class="add-to-cart-or-refresh">
                                                                                    <div class="product-quantity" style="display: none">
                                                                                        <input type="number" name="productId" value="<%=rsFeatured.getInt("productID")%>" class="product_page_product_id" />
                                                                    ...
                                                                    <div class="product-price-and-shipping">
                                                                        <span itemprop="price" class="price">
                                                                            <% int discountPrice = (100 - rsBestSellers.getInt("discount"))
                                                                                        * rsBestSellers.getInt("price") / 100;
                                                                                out.print(discountPrice + "<sup>d</sup>");
                                                                            %>
                                                                        </span>
