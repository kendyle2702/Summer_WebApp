...
<html lang="en">
  ...
  <body
    id="prices-drop"
    class="lang-en country-us currency-usd layout-left-column page-prices-drop tax-display-disabled"
    itemscope
        ...
        <section id="wrapper">
          ...
          <div class="container">
            ...
            <div id="content-wrapper" class="left-column col-xs-12 col-sm-8 col-md-9">
              <section id="main">
                <h2 id="js-product-list-header" class="h2 tt-innerpagetitle">On sale</h2>
                ...
                <section id="products">
                  <div>
                    <div id="js-product-list-top" class="products-selection">
                        ...
                        <div class="row sort-by-row">
                          ...
                          <div class="col-sm-12 col-xs-12 col-md-9 products-sort-order dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a rel="nofollow" href="prices-dropfe2d.html?order=product.name.asc" class="select-list current js-search-link">
                                Name, A to Z
                              </a>
                              <a rel="nofollow" href="prices-drop0279.html?order=product.name.desc" class="select-list js-search-link">
                                Name, Z to A
                              </a>
                              <a rel="nofollow" href="prices-drop8eb3.html?order=product.price.asc" class="select-list js-search-link">
                                Price, low to high
                              </a>
                              <a rel="nofollow" href="prices-drop04e6.html?order=product.price.desc" class="select-list js-search-link">
                                Price, high to low
                              </a>
                            </div>
                          </div>
                      ...
                      <div class="col-sm-12 hidden-md-up text-sm-center showing">Showing 1-8 of 8 item(s)</div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div id="js-product-list">
                      ...
                      <nav class="pagination">
                        <div class="col-md-4 pagination-left">Showing 1-8 of 8 item(s)</div>
