										...
										<div class="ttcat-content">
											...
											<div class="sub-cat">
												<ul>
													...
													%>
													<li>
														<a href="<%= rsPop.getInt("productID")%>" title="<%= productName%>"><%= productName%></a>
													</li>
													<%}%>
												</ul>
											</div>
															...
															<li class="item">
																		...
																		<div class="thumbnail-container">
																			<div class="ttproduct-image">
																				<a href="home/19-customizable-mug.html" class="thumbnail product-thumbnail">
																					<img class="ttproduct-img1" src="/img/ep_buoi_1.png"
																					...
																					<img class="fade second_image img-responsive" src="/img/ep_chanhday_4.png"
																				...
																				<div class="wishlist">
																					<a class="addToWishlist btn btn-primary wishlistProd_19" href="#"
																					   data-dismiss="modal" data-rel="19" title="Add to wishlist" onclick="WishlistCart('wishlist_block_list', 'add', '19', '0', 1);
																							   return false;">
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="19" data-dismiss="modal" title="Add to Compare">
																...
																<div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
																	<article class="product-miniature js-product-miniature col-sm-4"
																		...
																		<div class="thumbnail-container">
																			<div class="ttproduct-image">
																				<a href="home/18-hummingbird-notebook.html"
																				...
																				<div class="wishlist">
																					<a class="addToWishlist btn btn-primary wishlistProd_18" href="#"
																					   data-dismiss="modal" data-rel="18" title="Add to wishlist" onclick="WishlistCart('wishlist_block_list', 'add', '18', '36', 1);
																							   return false;">
																						<i class="material-icons wishlist-icon">favorite_border</i>
																						<span class="wishlist-name">Add to Wishlist</span>
																						<span class="loading"><i class="material-icons">cached</i></span>
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="18" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
															...
															<li class="item">
																...
																<div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
																	<article class="product-miniature js-product-miniature col-sm-4"
																		...
																		<div class="thumbnail-container">
																			<div class="ttproduct-image">
																				<a href="home/17-brown-bear-notebook.html"
																				   class="thumbnail product-thumbnail">
																					<img class="ttproduct-img1"
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="17" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
																			...
																			<div class="ttproduct-image">
																				...
																				<div class="wishlist">
																					<a class="addToWishlist btn btn-primary wishlistProd_16" href="#"
																					   ...
																					   onclick="WishlistCart('wishlist_block_list', 'add', '16', '28', 1);
																							   return false;">
																						<i class="material-icons wishlist-icon">favorite_border</i>
																						<span class="wishlist-name">Add to Wishlist</span>
																						<span class="loading"><i class="material-icons">cached</i></span>
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="16" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
																					...
																					<span class="h3 product-title" itemprop="name"><a
																							href="home/16-mountain-fox-notebook.html">Vodka Cranberry
																							drink</a></span>
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="15" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="14" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="13" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="12" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
															...
															<li class="item">
																...
																<div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
																	<article class="product-miniature js-product-miniature col-sm-4"
																		...
																		<div class="thumbnail-container">
																			<div class="ttproduct-image">
																				<a href="home/11-hummingbird-cushion.html"
																				   class="thumbnail product-thumbnail">
																					<img class="ttproduct-img1"
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="11" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
																					...
																					<span class="h3 product-title" itemprop="name"><a
																							href="home/11-hummingbird-cushion.html">Simply Organic
																							Juice</a></span>
																					...
																					<div class="highlighted-informations hidden-sm-down">
																						<div class="variant-links">
																							<a href="home/11-26-hummingbird-cushion.html#/8-color-white"
																			...
																			<div class="ttproduct-desc">
																				<div class="product-description">
																					...
																					<div class="ttproducthover">
																						...
																						<div class="compare">
																							<a class="add_to_compare btn btn-primary" href="#"
																							   data-id-product="10" data-dismiss="modal" title="Add to Compare">
																								<i class="material-icons compare_icon">equalizer</i>
																								<span>Add to Compare</span>
																								<span class="loading"><i class="material-icons">cached</i></span>
																							</a>
																					...
																					<span class="h3 product-title" itemprop="name"><a
																							href="home/10-brown-bear-cushion.html">Tropic Juice Bar
																							Deli</a></span>
																					...
																					<div class="highlighted-informations hidden-sm-down">
																						<div class="variant-links">
																							<a href="home/10-24-brown-bear-cushion.html#/8-color-white"
																							   class="color" title="White" style="background-color: #ffffff"><span
																									class="sr-only">White</span></a>
																							<a href="home/10-25-brown-bear-cushion.html#/11-color-black"
																							   class="color" title="Black" style="background-color: #434a54"><span
																									class="sr-only">Black</span></a>
																							<span class="js-count count"></span>
																						</div>
													...
													<article class="product-miniature js-product-miniature col-sm-4" data-id-product="16"
														...
														<div class="thumbnail-container">
															<div class="ttproduct-image">
																...
																<div class="wishlist">
																	<a class="addToWishlist btn btn-primary wishlistProd_16" href="#"
																	   data-dismiss="modal" data-rel="16" title="Add to wishlist" onclick="WishlistCart('wishlist_block_list', 'add', '16', '28', 1);
																			   return false;">
																		<i class="material-icons wishlist-icon">favorite_border</i>
																		<span class="wishlist-name">Add to Wishlist</span>
																		<span class="loading"><i class="material-icons">cached</i></span>
															...
															<div class="ttproduct-image">
																...
																<div class="wishlist">
																	<a class="addToWishlist btn btn-primary wishlistProd_4" href="#"
																	   data-dismiss="modal" data-rel="4" title="Add to wishlist" onclick="WishlistCart('wishlist_block_list', 'add', '4', '16', 1);
																			   return false;">
																		<i class="material-icons wishlist-icon">favorite_border</i>
																		<span class="wishlist-name">Add to Wishlist</span>
																		<span class="loading"><i class="material-icons">cached</i></span>
													...
													<article class="product-miniature js-product-miniature col-sm-4" data-id-product="10"
														...
														<div class="thumbnail-container">
															<div class="ttproduct-image">
																...
																<div class="wishlist">
																	<a class="addToWishlist btn btn-primary wishlistProd_10" href="#"
																	   data-dismiss="modal" data-rel="10" title="Add to wishlist" onclick="WishlistCart('wishlist_block_list', 'add', '10', '24', 1);
																			   return false;">
																		<i class="material-icons wishlist-icon">favorite_border</i>
																		<span class="wishlist-name">Add to Wishlist</span>
																		<span class="loading"><i class="material-icons">cached</i></span>
														...
														<div class="thumbnail-container">
															<div class="ttproduct-image">
																...
																<div class="wishlist">
																	<a class="addToWishlist btn btn-primary wishlistProd_8" href="#"
																	   data-dismiss="modal" data-rel="8" title="Add to wishlist"
																	   onclick="WishlistCart('wishlist_block_list', 'add', '8', '0', 1);
																			   return false;">
																		<i class="material-icons wishlist-icon">favorite_border</i>
																		<span class="wishlist-name">Add to Wishlist</span>
																		<span class="loading"><i class="material-icons">cached</i></span>
