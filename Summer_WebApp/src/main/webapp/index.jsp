                      ...
                      <div class="block_content">
                        ...
                        <div class="ttnewslatterpopup-content col-sm-6">
                          <form method="post">
                            ...
                            <div class="ttContent">
                              Subscribe to the Complex mailing list to receive updates on new arrivals, special offers
                            ...
                            <div class="content">
                              ...
                              <div class="ttcat-content">
                                ...
                                <div class="sub-cat">
                                  ...
                                  <ul>
                                    <% ResultSet rsCream=pDAO.getProductByCategory(3); while (rsCream.next()) { 
                                      String productName=rsCream.getString("ProductName"); %>
                                      <li>
                                        <a href="/product/detail/<%= rsCream.getInt("productID")%>" title="<%=
                          ...
                          <div class="item">
                            <div class="content">
                              ...
                              <div class="ttcat-content">
                                ...
                                <div class="sub-cat">
                                  <ul>
                                    <% ResultSet rsDrink=pDAO.getProductByCategory(4); while (rsDrink.next()) { 
                                      String productName=rsDrink.getString("ProductName");%>
                                      <li>
                                        <a href="/product/detail/<%= rsDrink.getInt("productID")%>" title="<%=
                                            productName%>"><%=productName%></a>
                                      </li>
                                      <%}%>
                                  </ul>
                          ...
                          <div class="item">
                            <div class="content">
                              ...
                              <div class="ttcat-content">
                                ...
                                <div class="sub-cat">
                                  <ul>
                                    <% ResultSet rsJuice=pDAO.getProductByCategory(2); while (rsJuice.next()) { 
                                      String productName=rsJuice.getString("ProductName");%>
                                      <li>
                                        <a href="/product/detail/<%= rsJuice.getInt("productID")%>" title="<%=
                                            productName%>"><%=productName%></a>
                                      </li>
                                      <%}%>
                                  </ul>
                          ...
                          <div class="item">
                            <div class="content">
                              ...
                              <div class="ttcat-content">
                                ...
                                <div class="sub-cat">
                                  <ul>
                                    <% ResultSet rsPop=pDAO.getProductByCategory(1); while (rsPop.next()) { 
                                      String productName=rsPop.getString("ProductName");%>
                                      <li>
                                        <a href="/product/detail/<%= rsPop.getInt("productID")%>" title="<%=
                            ...
                            <div class="ttcmsaboutusblock">
                              <div class="ttcmsaboutus-content">
                                ...
                                <div class="ttcmsaboutus-desc">
                                  Lorem ipsum dolor sit amet, consectetur adialiquip commodincididunt ut labore
                                  etsectetur
                      ...
                      <div id="content-wrapper">
                            ...
                            <div id="hometab" class="home-tab container">
                              <section class="ttnew-products clearfix col-sm-4">
                                ...
                                <div class="ttnew-content products">
                                  <% ResultSet rsNewProduct=pDAO.getNearSevenDay(); while(rsNewProduct.next()){ %>
                                          ...
                                          <div class="ttproduct-desc">
                                            ...
                                            <div class="product-price-and-shipping">
                                              <span itemprop="price" class="price">
                                                <% int discountPrice=(100 - rsNewProduct.getInt("discount")) *
                                                  rsNewProduct.getInt("price") /100; out.print(discountPrice+"<sup>d</sup>");
                                                  %>
                                              </span>

                                              <span class="sr-only">Regular price</span>
                                              <span class="discount-percentage discount-product">
                                                <%= rsNewProduct.getInt("discount")==0? "" :
                                                  -rsNewProduct.getInt("discount") + "%" %>
                                              </span>
                                              <span class="regular-price">
                                                <%= rsNewProduct.getInt("discount") !=0? rsNewProduct.getInt("price")
                                                  + "<sup>d</sup>" : "" %>
                                              </span>
                                    ...
                                    <div class="ttproduct-desc">
                                      <div class="product-description">
                                        ...
                                        <span class="h3 product-title" itemprop="name"><a
                                            ...
                                            ><%= rsFeatured.getString("productName")%></a></span>
                                        ...
                                        <div class="product-price-and-shipping">
                                          <span itemprop="price" class="price">
                                            <% int discountPrice=(100 - rsFeatured.getInt("discount")) *
                                              rsFeatured.getInt("price") /100; out.print(discountPrice+"<sup>d</sup>");
                                              %>
                                          </span>

                                          <span class="sr-only">Regular price</span>
                                          <span class="discount-percentage discount-product">
                                            <%= rsFeatured.getInt("discount")==0? "" : -rsFeatured.getInt("discount")
                                              + "%" %>
                                          </span>
                                          <span class="regular-price">
                                            <%= rsFeatured.getInt("discount") !=0? rsFeatured.getInt("price")
                                              + "<sup>d</sup>" : "" %>
                                          </span>
                        ...
                        <section class="ttbestseller-products clearfix col-sm-4">
                          ...
                          <div class="ttbestseller-content products">
                            <% ResultSet rsBestSellers=pDAO.getTop10BestSeller(); while(rsBestSellers.next()){ %>
                              <div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                <article class="product-miniature js-product-miniature col-sm-4" data-id-product="16"
                                  data-id-product-attribute="28">
                                  <div class="thumbnail-container">
                                    ...
                                    <div class="ttproduct-desc">
                                      <div class="product-description">
                                          ...
                                          <div class="tt-button-container">
                                            <div class="product-add-to-cart">
                                              <form action="/cart" method="post" class="add-to-cart-or-refresh">
                                                <div class="product-quantity" style="display: none">
                                                  <input 
                                                  type="number" name="productId" value="<%=rsBestSellers.getInt("productID")%>"
                                                  class="product_page_product_id"
                                                  />
                                                  <input type="number" name="id_customization" value="0"
                                                    class="product_customization_id" />
                                        ...
                                        <span class="h3 product-title" itemprop="name"><a
                                            ...
                                            ><%= rsBestSellers.getString("productName")%></a></span>
                                        ...
                                        <div class="product-price-and-shipping">
                                          <span itemprop="price" class="price">
                                            <% int discountPrice=(100 - rsBestSellers.getInt("discount")) *
                                              rsBestSellers.getInt("price") /100; out.print(discountPrice+"<sup>d</sup>");
                                              %>
                                          </span>

                                          <span class="sr-only">Regular price</span>
                                          <span class="discount-percentage discount-product">
                                            <%= rsBestSellers.getInt("discount")==0? "" :
                                              -rsBestSellers.getInt("discount") + "%" %>
                                          </span>
                                          <span class="regular-price">
                                            <%= rsBestSellers.getInt("discount") !=0? rsBestSellers.getInt("price")
                                              + "<sup>d</sup>" : "" %>
                                          </span>
                    ...
                    <section id="content" class="page-home">
                      ...
                      <section class="ttspecial-products clearfix bottom-to-top hb-animate-element">
                        ...
                        <div class="ttspecial-list container">
                          <div class="row">
                            <div class="products">
                              <%ResultSet rsSpecial=pDAO.get5SpecialProducts(); while(rsSpecial.next()){ %>
                                <div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                    ...
                                    <div class="thumbnail-container">
                                      ...
                                      <div class="ttproduct-desc">
                                        <div class="product-description">
                                            ...
                                            <div class="tt-button-container">
                                              <div class="product-add-to-cart">
                                                <form action="/cart" method="post" class="add-to-cart-or-refresh">
                                                  <div class="product-quantity" style="display: none">
                                                    <input 
                                                    type="number" name="productId" value="<%=rsSpecial.getInt("productID")%>"
                                                    class="product_page_product_id" />
                                                    <input type="number" name="id_customization" value="0"
                                                      class="product_customization_id" />
                                                    <input type="hidden" name="addCart"
                                          ...
                                          <span class="h3 product-title" itemprop="name"><a
                                              href="/product/detail/<%=rsSpecial.getInt("productID")%>"><%=
                                                rsSpecial.getString("productName")%></a></span>
                                          ...
                                          <div class="product-price-and-shipping">
                                            <span itemprop="price" class="price">
                                              <% int discountPrice=(100 - rsSpecial.getInt("discount")) *
                                                rsSpecial.getInt("price") /100; out.print(discountPrice+"<sup>d</sup>");
                                                %>
                                            </span>

                                            <span class="sr-only">Regular price</span>
                                            <span class="discount-percentage discount-product">
                                              <%= rsSpecial.getInt("discount")==0? "" : -rsSpecial.getInt("discount")
                                                + "%" %>
                                            </span>
                                            <span class="regular-price">
                                              <%= rsSpecial.getInt("discount") !=0? rsSpecial.getInt("price")
                                                + "<sup>d</sup>" : "" %>
                                            </span>
