  ...
  >
    ...
    <div class="newsletter-pop">
            ...
            <div id="newsletter_block_popup" class="block">
              <div class="block_content">
                <div class="ttnewslatterpopup-img col-sm-6">
                  <img
                    src="../modules/ttpopupnewsletter/views/img/newsletter.jpg"
                    class="img"
                    alt="bg-img"
                    width="290"
                    height="470"
                ...
                <div class="ttnewslatterpopup-content col-sm-6">
                  <form method="post">
                    ...
                    <div class="ttContent">
                      Subscribe to the Complex mailing list to receive updates
                    ...
                    <input
                      class="inputNew"
                      id="ttnewsletter-input"
                      type="text"
                      name="email"
                      placeholder="Enter your mail..."
                    />

                    <div class="send-reqest button_unique btn-primary">
                      Subscribe
                    </div>
                  </form>
                  ...
                  <div class="newsletter_block_popup-bottom">
                    <div class="subscribe-bottom">
                      <input
                        id="tt_newsletter_dont_show_again"
                        type="checkbox"
                      />
                    </div>

                    <label
                      class="tt_newsletter_dont_show_again"
                      for="tt_newsletter_dont_show_again"
      ...
      <script type="text/javascript">
        ...
        var field_path =
          "https://prestashop1.templatetrip.com/PRS01/PRS001_summer/modules/ttpopupnewsletter/ajax.php";
      </script>
    </div>
      ...
      <div id="page" class="">
        <div id="top_column" class="">
          <div
            id="carousel"
            data-ride="carousel"
            class="carousel slide homeslider"
            data-interval="5000"
            data-wrap="true"
            data-pause="hover"
          >
                  ...
                  <figure>
                    ...
                    <figcaption class="caption">
                      <div class="caption-description">
                        ...
                        <p>
                          <button class="shop_now animation-btn">
                            Shop Now
                          </button>
                        </p>
                      </div>
          ...
          <div id="tt_category_feature" class="tt_category_feature">
            ...
            <div class="list_carousel responsive container">
                    ...
                    <div class="ttcat-content">
                      ...
                      <div class="sub-cat">
                        <ul>
                          ...
                          <li>
                            <a
                              href="15-buttered-pecan.html"
                              title="Buttered Pecan"
                              >Buttered Pecan</a
                            >
                          </li>
                          <li>
                            <a href="16-strawberry.html" title="Strawberry"
                              >Strawberry</a
                            >
                          </li>
                          <li>
                            <a href="17-vanilla.html" title="Vanilla"
                              >Vanilla</a
                            >
                          </li>
                          <li>
                            <a
                              href="18-baskin-robbins.html"
                          ...
                          <li>
                            <a
                              href="19-jeni-s-splendid.html"
                              title="Jeni&#039;s Splendid"
                              >Jeni&#039;s Splendid</a
                            >
                          </li>
                        </ul>
                    ...
                    <div class="ttcat-content">
                      ...
                      <div class="sub-cat">
                        <ul>
                          ...
                          <li>
                            <a
                              href="21-strawberry-lemonade.html"
                          ...
                          <li>
                            <a
                              href="22-grape-raspberry.html"
                              title="Grape Raspberry"
                              >Grape Raspberry</a
                            >
                          </li>
                          <li>
                            <a href="23-crisp-apple.html" title="Crisp Apple"
                              >Crisp Apple</a
                            >
                          </li>
                          <li>
                            <a
                              href="24-kiwi-strawberry.html"
                  ...
                  <div class="content">
                    ...
                    <div class="ttcat-content">
                      ...
                      <div class="sub-cat">
                        <ul>
                          <li>
                            <a href="26-apple-juice.html" title="Apple Juice."
                              >Apple Juice.</a
                            >
                          </li>
                          <li>
                            <a
                              href="27-cranberry-juice.html"
                              title="Cranberry Juice"
                              >Cranberry Juice</a
                            >
                          </li>
                          <li>
                            <a href="29-beet-juice.html" title="Beet Juice"
                              >Beet Juice</a
                            >
                          </li>
                          <li>
                            <a
                              href="30-cantaloupe-juice.html"
                              title="Cantaloupe Juice"
                              >Cantaloupe Juice</a
                            >
                          </li>
                          <li>
                            <a
                              href="31-grapefruit-juice.html"
                  ...
                  <div class="content">
                    ...
                    <div class="ttcat-content">
                      ...
                      <div class="sub-cat">
                        <ul>
                          <li>
                            <a href="33-lemon-lime.html" title="Lemon Lime"
                              >Lemon Lime</a
                            >
                          </li>
                          <li>
                            <a href="34-punch-pink.html" title="Punch Pink"
                              >Punch Pink</a
                            >
                          </li>
                          <li>
                            <a href="35-tropical-tip.html" title="Tropical Tip"
                              >Tropical Tip</a
                            >
                          </li>
                          <li>
                            <a href="36-berry-blue.html" title="Berry Blue"
                              >Berry Blue</a
                            >
                          </li>
                          <li>
                            <a
                              href="37-strawberry-red.html"
                              title="Strawberry Red"
                              >Strawberry Red</a
                            >
                          </li>
                          <li>
                            <a href="38-giant-fat-.html" title="Giant Fat"
                              >Giant Fat</a
                            >
                          </li>
                        </ul>
              ...
              <div class="customNavigation">
                <a class="btn prev ttcategoryfeature_prev"
                  ><i class="material-icons">&#xe408;</i>Prev</a
                >
                <a class="btn next ttcategoryfeature_next"
                  ><i class="material-icons">&#xe409;</i>Next</a
                >
              </div>
            </div>
          </div>
          ...
          <script>
            $(document).ready(function () {
              ...
              $(
                ".tt_category_feature .content .ttcat-content .sub-cat > ul"
              ).each(function () {
          ...
          <div id="ttcmsaboutus">
            <div class="ttcmsaboutus container">
              <div class="row">
                <div
                  class="ttcmsaboutus ttaboutusbanner col-sm-6 col-md-7 col-xs-12"
                >
                ...
                <div
                  class="ttcmsaboutus ttaboutusdesc col-sm-6 col-md-5 col-xs-12"
                >
                  <div class="ttcmsaboutusblock">
                    <div class="ttcmsaboutus-content">
                      ...
                      <div class="ttcmsaboutus-desc">
                        Lorem ipsum dolor sit amet, consectetur adialiquip
                        commodincididunt ut labore etsectetur adialiquipsectetur
                        adialiquip
                      </div>
            ...
            <div id="content-wrapper">
              <section id="main">
                <div class="homebg bottom-to-top hb-animate-element">
                  ...
                  <div id="hometab" class="home-tab container">
                    <section class="ttnew-products clearfix col-sm-4">
                                        ...
                                        <div class="product-description">
                                          ...
                                          <div class="ttproducthover">
                                            ...
                                            <div class="compare">
                                              ...
                                              >
                                                <i
                                                  class="material-icons compare_icon"
                                                  >equalizer</i
                                                >
                      ...
                      <div class="customNavigation">
                        <a class="btn prev ttnew_prev"
                          ><i class="material-icons">&#xe408;</i>Prev</a
                        >
                        <a class="btn next ttnew_next"
                          ><i class="material-icons">&#xe409;</i>Next</a
                        >
                      </div>
                            ...
                            <div class="thumbnail-container">
                              ...
                              <div class="ttproduct-desc">
                                <div class="product-description">
                                  ...
                                  <span class="h3 product-title" itemprop="name"
                                    ><a href="home/10-brown-bear-cushion.html"
                                      >Tropic Juice Bar Deli</a
                                    ></span
                                  >
                ...
                <section id="content" class="page-home">
                  ...
                  >
                    <div
                      class="ttcmsclient container bottom-to-top hb-animate-element"
                    >
                      <div class="row">
                            ...
                            <li class="client-user1 tt-client">
                              ...
                              <div class="client-content col-sm-8">
                                <div class="client-desc">
                                  ...
                                  form, by injected believable. There variation
                                  words able s, but also the leap into
                                  electronic typesetting, the 1960s with the
                                  release of Letraset sheet passage.
                                </div>
                              </div>
                            </li>
                              ...
                              <div class="service">
                                ...
                                <div class="service-content">
                                  ...
                                  <div class="service-desc">
                                    Add in a few ice cubes. The drink is best
                                    served chilled!
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="ttcontent_inner">
                              <div class="service">
                                ...
                                <div class="service-content">
                                  ...
                                  <div class="service-desc">
                                    Garnish with fresh lime a few ice cubes.
                                    served chilled!
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="ttcontent_inner">
                              <div class="service">
                                ...
                                <div class="service-content">
                                  ...
                                  <div class="service-desc">
                                    Recommend to serve in a highball Add in a
                                    served chilled!.
                                  </div>
                                </div>
                              </div>
                  ...
                  <section
                    class="ttspecial-products clearfix bottom-to-top hb-animate-element"
                  >
                                ...
                                <div class="ttproduct-desc">
                                  <div class="product-description">
                                    ...
                                    <span
                                      class="h3 product-title"
                                      itemprop="name"
                                      ><a href="home/19-customizable-mug.html"
                                        >Cucumber Lemonade...</a
                                      ></span
                                    >
                    ...
                    <div class="container">
                      <div class="products_block_inner row">
                        <h2 class="homepage-heading">
                          <a href="smartblog.html" class="tt-title"
                            >Latest News</a
                          >
                        </h2>
                        <div class="sdsblog-box-content block_content">
                          <div
                            id="smartblog-carousel"
                                ...
                                <div class="blog_content col-md-6">
                                  <div class="blog_inner">
                                    <h4 class="sds_post_title">
                                      <a
                                        href="smartblog/5_viderer-voluptatum-te-eum.html"
                                        >Viderer voluptatum te eum</a
                                      >
                                    </h4>

                                    <p class="desc">
                                      Ei has mutat solum. Fugit atomorum
                                      efficiantur an vim, te...
                                    </p>
                                    <div class="read_more">
                                      <a
                              ...
                              <div class="blog_post col-sm-12">
                                ...
                                <div class="blog_content col-md-6">
                                  <div class="blog_inner">
                                    ...
                                    <p class="desc">
                                      Mea stet putent sadipscing an. Per prima
                                      equidem cu, sit...
                                    </p>
                                    <div class="read_more">
                                      <a
                                ...
                                <div class="blog_content col-md-6">
                                  <div class="blog_inner">
                                    <h4 class="sds_post_title">
                                      <a
                                        href="smartblog/2_upon-of-seasons-earth-dominion.html"
                                        >Upon of seasons earth...</a
                                      >
                                    </h4>

                                    <p class="desc">
                                      Nascetur ridiculus mus upon of seasons
                                      earth dominion....
                                    </p>
                                    <div class="read_more">
                                      <a
                  ...
                  <section class="brands bottom-to-top hb-animate-element">
                    <div class="container">
                      <span
                        class="h1 products-section-title text-uppercase tt-title"
                      >
                        Brands
                      </span>
                      <div class="products">
                        <ul id="ttbrandlogo-carousel" class="product_list">
                          ...
                          <li>
                            <div class="brand-image">
                              <a
                                href="brand/2-graphic-corner.html"
                          ...
                          <li>
                            <div class="brand-image">
                              <a
                                href="brand/1-studio-design.html"
                                title="Studio Design"
                              >
                                <img
                                  src="../img/m/1.jpg"
                        ...
                        <div class="customNavigation">
                          <a class="btn prev ttbrandlogo_prev"
                            ><i class="material-icons">&#xe408;</i>Prev</a
                          >
                          <a class="btn next ttbrandlogo_next"
                            ><i class="material-icons">&#xe409;</i>Next</a
                          >
                        </div>
                      </div>
