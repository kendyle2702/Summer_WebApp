      ...
      <section id="wrapper">
        ...
        <div class="container">
                              ...
                              <div class="thumbnail-container">
                                <div class="ttproduct-image">
                                  <a href="home/13-brown-bear-vector-graphics.html" class="thumbnail product-thumbnail">
                                    <img class="ttproduct-img1" src="../96-home_default/brown-bear-vector-graphics.jpg"
                              ...
                              <div class="thumbnail-container">
                                <div class="ttproduct-image">
                                  <a href="treats/12-mountain-fox-vector-graphics.html"
                                    class="thumbnail product-thumbnail">
                                    <img class="ttproduct-img1"
                                      src="../90-home_default/mountain-fox-vector-graphics.jpg" alt="Green Thumb Juice"
          ...
          <div id="content-wrapper" class="left-column col-xs-12 col-sm-8 col-md-9">
            <section id="main">
              <h2 id="js-product-list-header" class="h2 tt-innerpagetitle">
                On sale
              </h2>
                      ...
                      <div class="row sort-by-row">
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-9 products-sort-order dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a rel="nofollow" href="prices-dropfe2d.html?order=product.name.asc"
                              class="select-list current js-search-link">
                              Name, A to Z
                            </a>
                            <a rel="nofollow" href="prices-drop0279.html?order=product.name.desc"
                              class="select-list js-search-link">
                              Name, Z to A
                            </a>
                            <a rel="nofollow" href="prices-drop8eb3.html?order=product.price.asc"
                              class="select-list js-search-link">
                              Price, low to high
                            </a>
                            <a rel="nofollow" href="prices-drop04e6.html?order=product.price.desc"
                              class="select-list js-search-link">
                              Price, high to low
                            </a>
                          </div>
                          ...
                          <div class="thumbnail-container">
                            <div class="ttproduct-image">
                              <a href="treats/14-hummingbird-vector-graphics.html" class="thumbnail product-thumbnail">
                                <img class="ttproduct-img1" src="../102-home_default/hummingbird-vector-graphics.jpg"
                                  alt="Screwdriver Cocktail"
                                  data-full-size-image-url="https://prestashop1.templatetrip.com/PRS01/PRS001_summer/102-large_default/hummingbird-vector-graphics.jpg"
                                  width="290" height="290" />
                                <img class="fade second_image img-responsive"
