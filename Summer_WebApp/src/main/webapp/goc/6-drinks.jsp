                    ...
                    <ul id="facet_3968" class="collapse">
                      ...
                      <li>
                        <label class="facet-label" for="facet_input_3968_2">
                          ...
                          <a href="6-drinks2c67.html?q=Categories-Scoops"
                            class="_gray-darker search-link js-search-link" rel="nofollow">
                            Scoops
                            <span class="magnitude">(19)</span>
                          </a>
                    ...
                    <ul id="facet_64991" class="collapse">
                      ...
                      <li>
                        <label class="facet-label" for="facet_input_64991_1">
                          ...
                          <a href="6-drinksedf6.html?q=Composition-Cotton"
                            class="_gray-darker search-link js-search-link" rel="nofollow">
                            Cotton
                            <span class="magnitude">(2)</span>
                          </a>
                    ...
                    <ul id="facet_43809" class="collapse">
                      <li>
                        <label class="facet-label" for="facet_input_43809_0">
                          ...
                          <a href="6-drinksb297.html?q=Property-120+pages"
                            class="_gray-darker search-link js-search-link" rel="nofollow">
                            120 pages
                            <span class="magnitude">(3)</span>
                          </a>
                      ...
                      <li>
                        <label class="facet-label" for="facet_input_43809_2">
                          <span class="custom-checkbox">
                            <input id="facet_input_43809_2"
                              data-search-url="6-drinks60dd.html?q=Property-Removable+cover" type="checkbox" />
                            <span class="ps-shown-by-js"><i
                                class="material-icons rtl-no-flip checkbox-checked">&#xE5CA;</i></span>
                          </span>
                    ...
                    <ul id="facet_5695" class="collapse">
                      <li>
                        <label class="facet-label" for="facet_input_5695_0">
                          ...
                          <a href="6-drinks48c1.html?q=Dimension-40x60cm"
                            class="_gray-darker search-link js-search-link" rel="nofollow">
                            40x60cm
                            <span class="magnitude">(3)</span>
                          </a>
                      ...
                      <li>
                        <label class="facet-label" for="facet_input_5695_1">
                          ...
                          <a href="6-drinks701b.html?q=Dimension-60x90cm"
                            class="_gray-darker search-link js-search-link" rel="nofollow">
                            60x90cm
                            <span class="magnitude">(3)</span>
                          </a>
                      ...
                      <li>
                        <label class="facet-label" for="facet_input_5695_2">
                          ...
                          <a href="6-drinksd3b7.html?q=Dimension-80x120cm"
                            class="_gray-darker search-link js-search-link" rel="nofollow">
                            80x120cm
                            <span class="magnitude">(3)</span>
                          </a>
                ...
                <div id="js-product-list-header">
                  <div class="block-category card card-block">
                    ...
                    <div id="category-description" class="text-muted">
                      <p>
                        <span style="font-size: 10pt; font-style: normal">Items and accessories for your desk, kitchen
                          or
