<footer id="footer">
          ...
          <div class="col-md-12 linklist links">
            <div class="wrapper">
              ...
              <div
                ...
                data-target="#footer_sub_menu_93223"
              ...
              <ul id="footer_sub_menu_93223" class="collapse">
                <li>
                  <a
          ...
          <div id="newslatter" class="col-sm-12">
            <div class="block_newsletter">
              <div class="tt-content col-sm-6 left-to-right hb-animate-element">
                <h1 class="tt-blocktitle">Sign up for Newsletter</h1>
              </div>
              <div
              ...
              >
                ...
                >
                  <div class="row">
                    ...
                    <div class="col-xs-12">
                      <p id="block-newsletter-label" class="newsletter-desc">
            ...
            <ul id="contact-footer" class="collapse">
              ...
              <li class="block">
                <div class="data email">
                  <a href="mailto:demo@gmail.com" class="dropdown">
                    <div class="icon">
                      <i class="material-icons">&#xE158;</i>
                    </div>
      ...
      <div class="backtotop-img">
        <a href="#" class="goToTop" title="Back to top">
