                            ...
                            <div class="card mb-3">
                                <div class="card-header-tab card-header">
                                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                                        <i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>View Accounts
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%=rs.getBoolean("isDeleted")== false? "<span style='color:blue'>Active</span>":"<span style='color:red;font-weight:bold;'>Banned</span>"%></td>
                                                    <td>
                                                        <%
                                                            if(!rs.getString("role").equals("admin")){
                                                                if(rs.getBoolean("isDeleted")== false){%>
                                                                    <a href="/admin/account/ban/<%=rs.getString("email")%>"><button class="mb-2 mr-2 btn-icon btn-pill btn btn-outline-danger"><i class="pe-7s-trash btn-icon-wrapper"></i>Ban</button></a>
                                                                <%}
                                                                else{%>
