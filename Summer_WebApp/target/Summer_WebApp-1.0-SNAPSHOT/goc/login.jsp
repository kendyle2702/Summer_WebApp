...
<body>
    <%@include file="/componants/header.jsp" %>
        ...
        <main id="index" class="lang-en country-us currency-usd layout-full-width page-index tax-display-disabled"
                            ...
                            <section id="main">
                                ...
                                <section id="content" class="page-content card card-block">
                                    <section class="login-form">
                                        <form id="login-form"
                                            action="https://prestashop1.templatetrip.com/PRS01/PRS001_summer/en/login"
                                            method="post">
                                            <section>
                                            ...
                                            <footer class="form-footer text-sm-center clearfix">
                                                ...
                                                <button id="submit-login" class="btn btn-primary"
