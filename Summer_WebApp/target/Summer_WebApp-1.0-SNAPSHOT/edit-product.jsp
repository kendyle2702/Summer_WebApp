                                                ...
                                                <div class="scroll-area-xs" style="height: 150px">
                                                    <div class="scrollbar-container ps">
                                                        <ul class="nav flex-column">
                                                            <li class="nav-item-header nav-item">Email:<%=acc.getEmail()%></li>
                                                            <li class="nav-item">
                    ...
                    <div class="scrollbar-sidebar">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="mm-active">
                                    <a href="#"> <i class="metismenu-icon pe-7s-display1"></i>Analytics </a>
                                </li>
                            </ul>
                            <ul class="vertical-nav-menu">
                                <li class="app-sidebar__heading">Product Management</li>
                                <li class="mm-active">
                                    <a href="#"> <i class="metismenu-icon pe-7s-note2"></i>View Products </a>
                                </li>
                                <li>
                                    <a href="#"> <i class="metismenu-icon pe-7s-download"></i>Add Products </a>
                                </li>
                            </ul>
                            ...
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="mm-active">
                                    <a href="#"> <i class="metismenu-icon pe-7s-note2"></i>View Categories </a>
                                </li>
                                <li>
                                    <a href="#"> <i class="metismenu-icon pe-7s-download"></i>Add Categories </a>
                                </li>
                            </ul>
                            <ul class="vertical-nav-menu">
                                <li class="app-sidebar__heading">Order Management</li>
                                <li class="mm-active">
                                    <a href="#"> <i class="metismenu-icon pe-7s-note2"></i>View Orders </a>
                                </li>
                                <li>
                                    <a href="#"> <i class="metismenu-icon pe-7s-download"></i>Add Orders </a>
                                </li>
                            </ul>
                            <ul class="vertical-nav-menu">
                                <li class="app-sidebar__heading">Payment Management</li>
                                <li class="mm-active">
                                    <a href="#"> <i class="metismenu-icon pe-7s-note2"></i>View Payments </a>
                                </li>
                                <li>
                                    <a href="#"> <i class="metismenu-icon pe-7s-download"></i>Add Payments </a>
                                </li>
                            </ul>
                            <ul class="vertical-nav-menu">
                                <li class="app-sidebar__heading">Account Management</li>
                                <li class="mm-active">
                                    <a href="#"> <i class="metismenu-icon pe-7s-note2"></i>View Accounts </a>
                                </li>
                                <li>
                                    <a href="#"> <i class="metismenu-icon pe-7s-download"></i>Add Accounts </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-header-tab card-header">
                                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                                        <i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>View Product
                                    </div>
                                </div>
                                <div class="card-body">
                                    <%
                                        Product product = (Product) session.getAttribute("viewProduct");
                                    %>
                                    <form action="product" id="form-1" method="post" class="container form__box" enctype="multipart/form-data">
                                        <div class="mt-3 mb-3 row">
                                            <label for="productID" class="col-sm-2 col-form-label a">Product ID</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="productID" value="<%= product.getProductID()%>" name="productID" readonly>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="img__box mt-2"> <img src="${pageContext.request.contextPath}/img/<%= product.getImage()%>" alt="alt"/></div>
                                                <div class="message"></div>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="date" class="col-sm-2 col-form-label">Create Time</label>
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" id="date" name="date" value="<%= product.getCreateTime()%>" >
                                                <div class="message"></div>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <a class="btn btn-danger col-sm-2 ms-1" href="/product">Back to list</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
