                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="admin" id="form-1" method="POST" class="container form__box" enctype="multipart/form-data">
                                        <a id="stopSelling" href="/admin/product/delete/<%=product.getProductID()%>" style='display: none'><button class="mb-2 mr-2 btn-icon btn btn-warning "><i class="pe-7s-trash btn-icon-wrapper"></i>Stop Selling</button></a> 
                                        <a id="sellingAgain" href="/admin/product/again/<%=product.getProductID()%>" style='display: none'><button class="mb-2 mr-2 btn-icon btn btn-primary"><i class="pe-7s-tools btn-icon-wrapper"> </i>Selling again</button></a> 
                                            ...
                                            <div class="col-sm-10">
                                                <select id="category" name="category" class="form-select" aria-label="Default select example">
                                                    <%
                                                        ...
                                                        while (rs.next()) {%>
                                                        <option value="<%=rs.getString("categoryID")%>" <%=rs.getInt("categoryID")==(product.getCategoryID())?"selected":""%>><%=rs.getString("categoryName")%></option>
                                                    <%}
                                                    %>
                                                </select>
                                                <div class="message"></div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="description" rows="2" name="description"><%= product.getDescription()%></textarea>
                                                <div class="message"></div>
                                            </div>
                                        </div>
                                        <%
        ...
        <script>
            Validator({
                ...
                rules: [
                    ...
                    Validator.isRequire("#date", "Create Time is required")
                ]
            });
            ...
            document.querySelector("#stopSelling").addEventListener("click", function (event) {
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "Are you sure to stop selling the product?",
                    icon: "warning",
            ...
            document.querySelector("#sellingAgain").addEventListener("click", function (event) {
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "Do you want to resell the product?",
                    icon: "question",
                    showCancelButton: true,
                    confirmButtonColor: "#3085d6",
                    cancelButtonColor: "#d33",
