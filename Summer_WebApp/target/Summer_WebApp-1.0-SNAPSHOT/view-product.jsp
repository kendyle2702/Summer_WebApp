                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/admin/product/view/<%=rs.getInt("productID")%>"><button class="mb-2 mr-2 btn-icon btn-pill btn btn-outline-primary"><i class="pe-7s-tools btn-icon-wrapper"></i>View detail</button></a></td>
                                                </tr>
                                                <%}
                                            %>
