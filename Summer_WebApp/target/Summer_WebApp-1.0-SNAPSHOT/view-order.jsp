                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <%if (rs.getString("orderStatus").equals("Pending")) {%>
                                                    <a  href="/admin/order/accept/<%=rs.getInt("orderID")%>"><button class="mb-2 mr-2 btn-icon btn-pill btn btn-outline-success"><i class="pe-7s-upload btn-icon-wrapper"></i>Accept</button></a>
                                                    ...
                                                    <%}%>
                                                    <a  href="/admin/order/view/<%=rs.getInt("orderID")%>"><button class="mb-2 mr-2 btn-icon btn-pill btn btn-outline-primary"><i class="pe-7s-tools btn-icon-wrapper"></i>View Detail</button></a>
                                                </td>
                                            </tr>
                                            <%}
                                            %>
